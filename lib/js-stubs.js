addToLibrary({
    ...
    duckdb_web_fs_file_exists__sig: 'vpipi',
    duckdb_web_fs_file_exists: function (path, pathLen, url, urlLen) {
        return globalThis.DUCKDB_RUNTIME.checkFile(Module, path, pathLen, url, urlLen);
    },
